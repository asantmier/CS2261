...
void goToStart() {
    state = START;
    fillScreen(0x6F60);
    drawString(((240 - (24 * 6)) / 2), 60, "MARINE BIOLOGY SIMULATOR", 0);
    drawString(((240 - (20 * 6)) / 2), 80, "press SELECT to play", ((31) | (31)<<5 | (31)<<10));
    seed = 0;
}
...
void goToGame() {
    ...
    drawRect(0, 0, 240, 10, 0);

    drawString(1, 1, "Lives:", ((31) | (31)<<5 | (31)<<10));
    drawString(240 - 1 - 6 * 28, 1, "Score:", ((31) | (31)<<5 | (31)<<10));
    drawString(240 - 1 - 6 * 15, 1, "Hi-Score:", ((31) | (31)<<5 | (31)<<10));
 drawScore(1, 1, 6, hiscore, ((31) | (31)<<5 | (31)<<10));
}


void goToGameFromPause() {
    state = GAME;
    drawRect(((240 - (6 * 6)) / 2), 60, (6 * 6), 8, bgColor);
    drawRect(((240 - (23 * 6)) / 2), 90, (23 * 6), 8, bgColor);
    drawRect(((240 - (34 * 6)) / 2), 100, (34 * 6), 8, bgColor);
}

void goToPause() {
    state = PAUSE;
    drawString(((240 - (6 * 6)) / 2), 60, "PAUSED", 0);
    drawString(((240 - (23 * 6)) / 2), 90, "press SELECT to unpause", 0);
    drawString(((240 - (34 * 6)) / 2), 100, "press START to go to start screen", 0);
}
...
void goToLose() {
    ...
    if (score > hiscore) {
        hiscore = score;
        drawString(1 + ((240 - (6 * 15)) / 2), 1 + 20, "NEW HIGH SCORE!", 0);
        drawString(((240 - (6 * 15)) / 2), 20, "NEW HIGH SCORE!", ((0) | (31)<<5 | (0)<<10));
    }
    drawString(1 + ((240 - (6 * 8)) / 2), 1 + 80, "YOU LOST", 0);
    drawString(((240 - (6 * 8)) / 2), 80, "YOU LOST", ((31) | (0)<<5 | (0)<<10));
    drawString(((240 - (6 * 25)) / 2), 100, "press SELECT to try again", 0);
}
