...
// It should take in the collisionMap and MAPWIDTH (use the ones defined in game.c).
// colShift and rowShift is the amount that the player is moving in the col direction and row direction, respectively.
// Do not worry about looping through and letting the player move until they hit a collision point, just do one set of checks.
// If the above statement confuses you, don't worry about it. I'm just telling you not to overthink this.
