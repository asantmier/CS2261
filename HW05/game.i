...
void initBarrels() {
    for (int i = 0; i < 10; i++) {
        ...
        barrels[i].y = 0;
        barrels[i].active = 0;
        shadowOAM[BARREL_IDX + i].attr0 = (2 << 8);
    }
}
...
void update() {
    ...
    updateHUD();
    if (hammer.active) {
        shadowOAM[HAMMER_IDX].attr0 = hammer.y | (0 << 8) | (0 << 14);
        shadowOAM[HAMMER_IDX].attr1 = hammer.x | (1 << 14);
        shadowOAM[HAMMER_IDX].attr2 = ((6)*32 + (4)) | ((1) << 10);
    } else {
        shadowOAM[HAMMER_IDX].attr0 = (2 << 8);
    }
}
...
void updateDK() {
    ...
    case NORMAL:
        ...
        {
        case 0:
            shadowOAM[DK_IDX].attr2 = ((12)*32 + (24)) | ((1) << 10);
            break;
        case 1:
            shadowOAM[DK_IDX].attr2 = ((12)*32 + (8)) | ((1) << 10);
            break;
        case 2:
            shadowOAM[DK_IDX].attr2 = ((12)*32 + (16)) | ((1) << 10);
            break;
        case 3:
            shadowOAM[DK_IDX].attr2 = ((12)*32 + (24)) | ((1) << 10);
            break;
        ...
        break;
    case NO_BARREL:
        shadowOAM[DK_IDX].attr2 = ((12)*32 + (0)) | ((1) << 10);
        break;
    case BARREL:
        shadowOAM[DK_IDX].attr2 = ((16)*32 + (0)) | ((1) << 10);
        break;
    }
...
void updateHUD() {
    ...
    int y = 0;
    int start = 140;
    shadowOAM[L_PARAN_IDX].attr0 = y | (0 << 8) | (2 << 14);
    shadowOAM[L_PARAN_IDX].attr1 = start | (0 << 14);
    shadowOAM[L_PARAN_IDX].attr2 = ((22)*32 + (0)) | ((0) << 10);
    shadowOAM[M_IDX].attr0 = y | (0 << 8) | (0 << 14);
    shadowOAM[M_IDX].attr1 = (start + (8 * 1)) | (0 << 14);
    shadowOAM[M_IDX].attr2 = ((22)*32 + (1)) | ((0) << 10);
    shadowOAM[LIFECOUNT_IDX].attr0 = (y + 8) | (0 << 8) | (0 << 14);
    shadowOAM[LIFECOUNT_IDX].attr1 = (start + (8 * 1)) | (0 << 14);
    shadowOAM[LIFECOUNT_IDX].attr2 = ((20)*32 + (lives)) | ((0) << 10);
    shadowOAM[M1_PARAN_IDX].attr0 = y | (0 << 8) | (2 << 14);
    shadowOAM[M1_PARAN_IDX].attr1 = (start + (8 * 2)) | (0 << 14);
    shadowOAM[M1_PARAN_IDX].attr2 = ((22)*32 + (2)) | ((0) << 10);
    for (int i = 0; i < 5; i++) {
        shadowOAM[HIGHSCORE_TXT_IDX + i].attr0 = y | (0 << 8) | (0 << 14);
        shadowOAM[HIGHSCORE_TXT_IDX + i].attr1 = (start + (8 * (3 + 1 + i))) | (0 << 14);
        shadowOAM[HIGHSCORE_TXT_IDX + i].attr2 = ((21)*32 + (5 + i)) | ((0) << 10);
    }
    int denominator = 1;
    for (int i = 6; i >= 0; i--) {
        shadowOAM[HIGHSCORE_NUM_IDX + i].attr0 = (y + 8) | (0 << 8) | (0 << 14);
        shadowOAM[HIGHSCORE_NUM_IDX + i].attr1 = (start + (8 * (3 + i))) | (0 << 14);
        shadowOAM[HIGHSCORE_NUM_IDX + i].attr2 = ((20)*32 + (((score % (10 * denominator)) / denominator))) | ((0) << 10);
        denominator *= 10;
    }
    shadowOAM[M2_PARAN_IDX].attr0 = y | (0 << 8) | (2 << 14);
    shadowOAM[M2_PARAN_IDX].attr1 = (start + (8 * 10)) | (0 << 14);
    shadowOAM[M2_PARAN_IDX].attr2 = ((22)*32 + (2)) | ((0) << 10);
    shadowOAM[L_IDX].attr0 = y | (0 << 8) | (0 << 14);
    shadowOAM[L_IDX].attr1 = (start + (8 * 11)) | (0 << 14);
    shadowOAM[L_IDX].attr2 = ((22)*32 + (7)) | ((0) << 10);
    shadowOAM[LEVELCOUNT_IDX].attr0 = (y + 8) | (0 << 8) | (0 << 14);
    shadowOAM[LEVELCOUNT_IDX].attr1 = (start + (8 * 11)) | (0 << 14);
    shadowOAM[LEVELCOUNT_IDX].attr2 = ((20)*32 + (levelsCleared)) | ((0) << 10);
    shadowOAM[R_PARAN_IDX].attr0 = y | (0 << 8) | (2 << 14);
    shadowOAM[R_PARAN_IDX].attr1 = (start + (8 * 12)) | (0 << 14);
    shadowOAM[R_PARAN_IDX].attr2 = ((22)*32 + (8)) | ((0) << 10);
