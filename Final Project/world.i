...
void drawPlayer() {
    ...
    shadowOAM[PLAYER_IDX].attr2 = ((28)*32 + (0)) | ((2) << 10);
}
...
void updateBullet(BULLET* bullet) {
        ...
        (bullet->y > 160)))
    {
        ...
        shadowOAM[bullet->spriteIdx].attr2 = ((31)*32 + (0)) | ((2) << 10);
    } else {
...
void drawEnemy(ENEMY* enemy) {
    ...
    if (drawnEnemies < 10) {
        ...
        {
        case 0:
            shadowOAM[ENEMY1 + drawnEnemies].attr2 = ((29)*32 + (0)) | ((2) << 10);
            break;
        case 1:
            shadowOAM[ENEMY1 + drawnEnemies].attr2 = ((29)*32 + (2)) | ((2) << 10);
            break;
        case 2:
            shadowOAM[ENEMY1 + drawnEnemies].attr2 = ((29)*32 + (4)) | ((2) << 10);
            break;
        }
        drawnEnemies++;
    }
...
void drawMine(MINE* mine) {
    ...
    if (drawnMines < 20) {
        ...
        {
        case 0:
            shadowOAM[MINE1 + drawnMines].attr2 = ((30)*32 + (0)) | ((2) << 10);
            break;
        case 1:
            shadowOAM[MINE1 + drawnMines].attr2 = ((30)*32 + (1)) | ((2) << 10);
            break;
        case 2:
            shadowOAM[MINE1 + drawnMines].attr2 = ((30)*32 + (2)) | ((2) << 10);
            break;
        }
