...
COMBATANT CBT_FISH = { "FISH", 1, 10, 10, 3, { &MOVE_NIBBLE, &MOVE_FLAIL, &MOVE_REGEN, &MOVE_NONE, &MOVE_NONE, &MOVE_NONE }, ((18)*32 + ((0)*2)) };
COMBATANT CBT_SHARK = { "SHARK", 1, 16, 16, 2, { &MOVE_STRIKE, &MOVE_SHEAL, &MOVE_NONE, &MOVE_NONE, &MOVE_NONE, &MOVE_NONE }, ((22)*32 + ((0)*2)) };
COMBATANT CBT_ANGLER = { "ANGLER", 1, 24, 24, 3, { &MOVE_BITE, &MOVE_LHEAL, &MOVE_LHEALBURST, &MOVE_NONE, &MOVE_NONE, &MOVE_NONE }, ((20)*32 + ((4)*2)) };
COMBATANT CBT_PUFFER = { "PUFFER", 1, 28, 28, 3, { &MOVE_NIBBLE, &MOVE_PUFFUP, &MOVE_SHEALBURST, &MOVE_NONE, &MOVE_NONE, &MOVE_NONE }, ((22)*32 + ((4)*2)) };
