...
extern int ballsTransformed;




enum {BLACKID=(256-6), PORTAGEID, PERSIANID, VIOREDID, WHITEID, GRAYID};
...
# 1 "small_image.h" 1
# 21 "small_image.h"
extern const unsigned short small_imageBitmap[128];


extern const unsigned short small_imagePal[256];
# 6 "game.c" 2
...
void initGame() {
 ...
 unsigned short colors[6] = {0, ((18) | (19)<<5 | (27)<<10), ((0) | (21)<<5 | (20)<<10), ((28) | (8)<<5 | (16)<<10), ((31) | (31)<<5 | (31)<<10), ((15) | (15)<<5 | (15)<<10)};


 DMANow(3, small_imagePal, ((unsigned short *)0x5000000), 512 / 2);
...
void updatePlayer() {
 ...
 if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0)))) && player.bulletTimer >= 15) {
